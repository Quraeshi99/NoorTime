...
def calculate_display_times_from_service(user_settings, api_times_today, app_config):
    ...
    # Calculate Chasht time: 20 minutes 30 seconds after Sunrise
    ...
    if sunrise_time_obj:
        ...
        calculated_times["chasht"] = {
            "azan": _format_time_obj(chasht_time_obj),
            "jamaat": "N/A" # Chasht typically doesn't have a separate jamaat time
        }
    else:
