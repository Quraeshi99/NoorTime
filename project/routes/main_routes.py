...
def user_settings_to_dict(user_settings):
    if not user_settings:
        return {}
    return {
        'default_latitude': user_settings.default_latitude,
        'default_longitude': user_settings.default_longitude,
        'default_calculation_method': user_settings.default_calculation_method,
        'time_format_preference': user_settings.time_format_preference,
    }
