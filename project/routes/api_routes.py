...
def get_tomorrow_display_for_current_prayer(today_api_times, api_times_tomorrow, user_prayer_settings_obj):
    """आज के वक़्त के आधार पर यह function बताता है कि कल उसी नमाज़ का वक़्त क्या होगा।"""
    now = datetime.now()
